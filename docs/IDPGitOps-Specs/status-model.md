---
title: Implementation Status Model — IDPGitOps
status: draft
owner: TBD
updated: 2026-09-18
---

# Implementation Status Model — IDPGitOps
...
```
| F-001-T7 | done — go test ./policy/... green, 94% | `platform/gateway/policy/` |
| F-001-T8 | blocked — waiting on ADR-0011 (ramp fail-closed direction) | — |
```
